...
from Functions.initialize import initialize_particles_landau_damping_2species, make_batch_ids
...
def time_cycle(x1, v11, v12, w1, x2, v21, v22, w2, E1, E2, B3, par):
    ...
    for step in range(1, ntot + 1):
        ...
        if par.collision_active:
            batch1 = make_batch_ids(par.N1, par, rng_batch)
            batch2 = make_batch_ids(par.N2, par, rng_batch)
        ...
        vf12 = v12 + par.dt * par.q_over_m1 * (Ep12 - old_v11 * Bp13)
        vf21 = v21 + par.dt * par.q_over_m2 * (Ep21 + v22 * Bp23)
        vf22 = v22 + par.dt * par.q_over_m2 * (Ep22 - old_v21 * Bp23)
